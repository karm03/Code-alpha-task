$(document).ready(function () {
  ...
  var typed = new Typed(".typing", {
    strings: ["Front End Developer", "Python Developer", "Web Developer", "Computer Engineer"],
    typeSpeed: 100,
    backSpeed: 60,
    loop: true,
  });
  ...
  var typed = new Typed(".typing2", {
    strings: ["Front End Developer", "Front End Developer", "Python Developer", "Computer Engineer"],
    typeSpeed: 100,
    backSpeed: 60,
    loop: true,
  });
